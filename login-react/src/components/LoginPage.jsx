...
export default function LoginPage() {
  ...
  const handleLogin = (e) => {
    ...
    if (!email.endsWith('@sena.edu.co') && !email.endsWith('@misena.edu.co')) {
      setError('El correo institucional debe terminar en @sena.edu.co');
      return;
    }
    ...
    setTimeout(() => {
      setIsLoading(false);
      // Simulating redirect to dashboard.html
          ...
          <div className="w-full max-w-md mx-auto">
            ...
            <div className="grid grid-cols-2 gap-4 mb-6">
              ...
              <button
                ...
                className={`relative flex flex-col items-center text-center p-5 rounded-xl border transition-all duration-300 ${
                  role === 'instructor'
              ...
              >
                ...
                {/* Red/Orange gear icon highlight detail */}
            ...
            <form onSubmit={handleLogin} className="space-y-5">
              ...
              <div>
                ...
                <span className="block text-[10px] text-green-700 mt-1.5 pl-0.5">
                  Usa tu correo institucional @sena.edu.co
                </span>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <button
                    ...
                    className="absolute inset-y-0 right-0 pr-3.5 flex items-center text-gray-600 hover:text-gray-900 transition-colors"
                  >
